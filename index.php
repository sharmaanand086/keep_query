...
<br><br>
                   ...
                   <?php 
                    $conn = mysqli_connect('localhost', 'username', 'password@123', 'stftitle');
                 ...
                 <input type="hidden" id="product" value="" name="product" >
                  ...
                  <label>GST: &nbsp; &nbsp;</label> <input type="text" id="gst" value="0" disabled="disabled">
