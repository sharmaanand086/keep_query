                ...
                <div class="inner-section">
                    ...
                    <div class="input-sections">
                        <input class="user name" id="name" type="text" name="name" placeholder="Name">
                         <input class="user phone" id="phone" type="text" name="phone" placeholder="Contact Number" required>
                        <input class="user" id="email" type="text" name="email" placeholder="Email ID" required>
                        ...
                        <input class="user message" id="confirm_password" type="password" name="cpassword" placeholder="Confirm Password">
                         <input class="user" id="dob" type="text" onfocus="(this.type='date')" name="dob" placeholder="Date of birth." required>
